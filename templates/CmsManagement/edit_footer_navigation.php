...
$this->assign('title', SITE_TITLE.' :: Edit Footer Navigation');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Edit Footer Navigation</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="type" name="type" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                	<option <?php if($editData->type == 'cms'){e('selected');}; ?> value="cms">CMS</option>
                                    <option <?php if($editData->type == 'custom'){e('selected');}; ?> value="custom">Custom</option>
                                </select>
                                <span id="typeError" class="admin_login_error"></span>
                            </div>
                            <div id="cmsPageDiv" <?php if($editData->type == 'cms'){ ?> style="display:block;"; <?php } else { ?> style="display:none;"; <?php } ?> >
                            <div class="form-group">
                                ...
                                <select id="menu_page_id" name="menu_page_id" onchange="checkError(this.id);" confirmation="false" class="form-control">
                                	...
                                	<?php if(isset($cmsPageList) && !empty($cmsPageList)){ ?>                                    	
                                    	<?php foreach($cmsPageList as $cmsKey => $cmsVal): ?>
                                        	<option <?php if($cmsKey == $editData->menu_page_id){e('selected');}; ?> value="<?php e($cmsKey); ?>"><?php e($cmsVal); ?></option>
                                        <?php endforeach; ?>
                                    <?php } ?>
                                </select>
                            ...
                            <div id="customPageDiv" <?php if($editData->type == 'custom'){ ?> style="display:block;"; <?php } else { ?> style="display:none;"; <?php } ?>>
                            <div class="form-group">
                                <label>Title:</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="seo_keyword" value="<?php e($editData->seo_keyword); ?>" name="seo_keyword" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
