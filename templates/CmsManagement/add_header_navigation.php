...
$this->assign('title', SITE_TITLE.' :: Add Header Navigation');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Add Header Navigation</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Add header navigation page information
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <?php //if(isset($headerNavigationList) && $headerNavigationList->count()>0){ ?>
                            <div class="form-group">                            	
                                <label>Parent Category</label>
                                <select name="parent_id" id="parent_id" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <?php echo $this->Navigation->getSubCategory($headerNavigationList); ?>
                                </select>
                            </div>
                            <?php //} ?>
                            <div class="form-group">
