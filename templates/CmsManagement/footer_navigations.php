...
$this->assign('title', SITE_TITLE.' :: Footer Navigation Management');
...
<div class="row">
    ...
    <!-- page header -->
    <div class="col-lg-12">
        <h1 class="page-header">Footer Navigation Management</h1>
    </div>    
    <!--end page header -->
</div>
<div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <?= $this->Form->end() ?>
        <a style="float:right;" href="<?php e($this->Url->build(ADMIN_FOLDER.'/add-footer-navigation/'));?>" title="Add Service" class="btn btn-default">Add Footer Navigation</a>
    </div>
    <input type="hidden" value="<?php e($this->Url->build(ADMIN_FOLDER.'/footer-navigation-filter/'));?>" id="paginatUrl">
...
function searchData(){
	...
	$.ajax({
		type: 'POST',
		url: '<?php e($this->Url->build(ADMIN_FOLDER.'/footer-navigation-filter/'));?>',
