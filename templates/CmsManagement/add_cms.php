...
$this->assign('title', SITE_TITLE.' :: Add Cms Page');
...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea id="description" name="description" onkeyup="checkError(this.id);" rows="10" confirmation="false" class="form-control"></textarea>
            ...
            <!-- End Form Elements -->
            <a href="<?php e($this->Url->build(ADMIN_FOLDER.'cms'.'/'));?>" class="btn btn-info">Back To Listing</a>
        </div>
    </div>
</div>
