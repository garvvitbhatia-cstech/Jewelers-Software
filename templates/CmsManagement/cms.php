...
$this->assign('title', SITE_TITLE.' :: Cms Page Management');
...
<div class="row">
    ...
    <!-- page header -->
    <div class="col-lg-12">
        <h1 class="page-header">Cms Page Management</h1>
    </div>    
    <!--end page header -->
</div>
<div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <?= $this->Form->end() ?>
        <a style="float:right;" href="<?php e($this->Url->build(ADMIN_FOLDER.'/add-cms/'));?>" title="Add Service" class="btn btn-default">Add Cms</a>
    </div>
    <input type="hidden" value="<?php e($this->Url->build(ADMIN_FOLDER.'/cms-filter/'));?>" id="paginatUrl">
...
function searchData(){
	...
	$.ajax({
		type: 'POST',
		url: '<?php e($this->Url->build(ADMIN_FOLDER.'/cms-filter/'));?>',
