...
$this->assign('title', SITE_TITLE.' :: Edit Weight Type');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Edit Weight Type</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    Update weight type information
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="type" name="type" value="<?php e($editData->type);?>" onkeyup="checkError(this.id);" confirmation="false" class="form-control" style="text-transform: capitalize;">
