...
$this->assign('title', SITE_TITLE.' :: Add Distance');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Add Distance</h1>
        </div>
        <!--end page header -->
    </div> 
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="weight_type_id" name="weight_type_id" class="form-control" onchange="getWeightByType(this.value); checkError(this.id);">
                            ...
                            <div class="form-group">                            
                                ...
                                <input type="text" id="dist_from" name="dist_from" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <span id="dist_fromError" class="admin_login_error"></span>
                            </div>  
                            <div class="form-group">                            
                                <label>Distance To:<span class="mandatory_field">*</span></label>
                                <input type="text" id="dist_to" name="dist_to" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <span id="dist_toError" class="admin_login_error"></span>
                            </div>  
                            <div class="form-group">                            
                                <label>Price:<span class="mandatory_field">*</span></label>
                                <input type="text" id="price" name="price" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
