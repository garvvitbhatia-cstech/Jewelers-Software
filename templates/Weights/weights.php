...
$this->assign('title', SITE_TITLE.' :: Weight Management');
...
<div class="row">
    ...
    <!-- page header -->
    <div class="col-lg-12">
        <h1 class="page-header">Weight Management</h1>
    </div>    
    <!--end page header -->
</div>
<div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <select name="weight_type_id" id="weight_type_id"  class="form-control filter searchOptions"  style="width:200px !important; display:none;">
        ...
        <input name="weight" id="weight" placeholder="Weight" class="form-control filter searchOptions"  style="width:200px !important; display:none;">
        ...
        <?= $this->Form->end() ?>
        <a style="float:right;" href="<?php e($this->Url->build(ADMIN_FOLDER.'/add-weight/'));?>" title="Add Weight" class="btn btn-default">Add Weight</a>
    </div>
    <input type="hidden" value="<?php e($this->Url->build(ADMIN_FOLDER.'/weight-filter/'));?>" id="paginatUrl">
...
function searchData(){
	...
	$.ajax({
		type: 'POST',
		url: '<?php e($this->Url->build(ADMIN_FOLDER.'/weight-filter/'));?>',
