...
$this->assign('title', SITE_TITLE.' :: Add Weight');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Add Weight</h1>
        </div>
        <!--end page header --> 
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select id="weight_type_id" name="weight_type_id" class="form-control" onchange="checkError(this.id);">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" id="weight" name="weight" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
