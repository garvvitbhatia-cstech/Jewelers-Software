<?php
   ...
   $this->assign('title', SITE_TITLE.' :: Edit Transporter');
...
<div id="page-wrapper">
   <div class="row">
      <!-- page header -->
      <div class="col-lg-12">
         <h1 class="page-header">Edit Transporter</h1>
      </div>
      <!--end page header -->
   </div>
   <div class="row">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     ...
                     <div class="form-group">
                        ...
                        <select name="vehicle_id" id="vehicle_id" onchange="checkError(this.id);" confirmation="false" class="form-control">
                           <?php if(isset($vehicleTypeList) && !empty($vehicleTypeList)){ ?>
                           <?php foreach($vehicleTypeList as $key => $val): ?>
                           <option <?php if($editData->vehicle_id == $key){e('selected');} ?> value="<?php e($key); ?>"><?php e($val); ?></option>
                           <?php endforeach; ?>
                           <?php } ?>
                        </select>
                     ...
                     <div class="form-group">
                        ...
                        <input type="text" id="dl_no" name="dl_no" maxlength="10" value="<?php e($editData->dl_no);?>" onkeyup="checkError(this.id);" confirmation="false" class="form-control" style="text-transform: uppercase;">
                        <span id="dl_noError" class="admin_login_error"></span>
                     </div>
                     <div class="form-group">
                        <label>RC No:<span class="mandatory_field">*</span></label> 
                        <input type="text" id="rc_no" name="rc_no" maxlength="10" value="<?php e($editData->rc_no);?>" onkeyup="checkError(this.id);" confirmation="false" class="form-control"style="text-transform: uppercase;">
                     ...
                     <div class="form-group cropped" id="cropped">
                        <?php
                           if(!empty($editData->dl_image)){                                 
                           
                               $imgPath = WWW_ROOT.'img/users/dl/'.$editData->dl_image;
                           
                               if(is_file($imgPath)){
                           
                                   e($this->Html->image('users/dl/'.$editData->dl_image, array('title'=>$editData->dl_no, 'alt'=> $editData->dl_no, 'width' => '100' )));
                     ...
                     <div class="form-group">
                        ...
                        <input type="file" id="dl_image" name="dl_image" accept="image/jpeg, image/png" onchange="checkError(this.id);" class="form-control" />
                     </div>
                     <div class="form-group cropped" id="cropped">
                        <?php
                           if(!empty($editData->rc_image)){ 
                           
                               $imgPath = WWW_ROOT.'img/users/rc/'.$editData->rc_image;
                           
                               if(is_file($imgPath)){
                           
                                   e($this->Html->image('users/rc/'.$editData->rc_image, array('title'=>$editData->rc_no, 'alt'=> $editData->rc_no, 'width' => '100' )));
                     ...
                     <div class="form-group">
                        <label>RC</label>
                        <input type="file" id="rc_image" name="rc_image" accept="image/jpeg, image/png" onchange="checkError(this.id);" class="form-control" />
                     </div>
                     <div class="form-group cropped" id="cropped">
                        <?php
                           if(!empty($editData->fitness_image)){                                 
                           
                               $imgPath = WWW_ROOT.'img/users/fitness/'.$editData->fitness_image;
                           
                               if(is_file($imgPath)){
                           
                                   e($this->Html->image('users/fitness/'.$editData->fitness_image, array('title'=>$editData->rc_no, 'alt'=> $editData->rc_no, 'width' => '100' )));
                     ...
                     <div class="form-group">
                        ...
                        <input type="file" id="fitness_image" name="fitness_image" accept="image/jpeg, image/png" onchange="checkError(this.id);" class="form-control" />
                     </div>
                     <div class="form-group">
                        <label>Status</label>
                        <div class="checkbox">
