<?php
	...
	$this->assign('title', SITE_TITLE.' :: Category Management');
...
<div class="panel panel-primary">
    <div class="panel-heading">
        ...
        <?= $this->Form->end() ?>
        <a style="float:right;" href="<?php e($this->Url->build(ADMIN_FOLDER.'/add-category/'));?>" title="Add Service" class="btn btn-default">Add Category</a>
    </div>
    <input type="hidden" value="<?php e($this->Url->build(ADMIN_FOLDER.'/categories-filter/'));?>" id="paginatUrl">
...
function searchData(){
	...
	$.ajax({
		type: 'POST',
		url: '<?php e($this->Url->build(ADMIN_FOLDER.'/categories-filter/'));?>',
