<?php
	...
	$this->assign('title', SITE_TITLE.' :: Add Category');
...
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            <a href="<?php e($this->Url->build(ADMIN_FOLDER.'categories'.'/'));?>" class="btn btn-info">Back To Listing</a><br />&nbsp;
        </div>
        <div class="col-lg-12">
            <!-- Form Elements -->
            ...
            <!-- End Form Elements -->
            <a href="<?php e($this->Url->build(ADMIN_FOLDER.'categories'.'/'));?>" class="btn btn-info">Back To Listing</a>
        </div>
    </div>
</div>
...
$(document).ready(function(e){   	
    ...
    $('.submitBtn').click(function(){
        ...
        if(frmSubmitted == 0){
            if($.trim($('#name').val()) == ""){
                //$('#nameError').show().html('Please enter category title.').slideDown();
               // $('#name').focus();
                //frmSubmitted = 0;
               // flag = 1; return false;
            }
