...
$this->assign('title', SITE_TITLE.' :: Edit Testimonial');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Edit Testimonial Details</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="username" name="username" value="<?php e($editData->username); ?>" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <span id="usernameError" class="admin_login_error"></span>
                            </div>
                            <div class="form-group">
                                <label>Testimonial:</label>
                                <textarea id="testimonial" name="testimonial" onkeyup="checkError(this.id);" rows="8" confirmation="false" class="form-control"><?php e($editData->testimonial); ?></textarea>
                                <span id="testimonialError" class="admin_login_error"></span>
                            </div>
                            <div class="form-group cropped" id="cropped">
                            	<?php
                                if($editData->profile != ""){
                                    $imgPath = WWW_ROOT.'img/testimonials/'.$editData->profile;
                                    if(is_file($imgPath)){
                                        e($this->Html->image('testimonials/'.$editData->profile, array('title'=>$editData->username, 'alt'=> $editData->username, 'width' => '100' )));
                                    }
                                } ?>
                            </div>
                            <div class="form-group">
...
$(document).ready(function(e){   	
	//$('#username').filter_input({regex:'[A-Za-z-_ ]'});
...
var oldImage ='<?php e($this->encryptData($editData->profile));?>';
