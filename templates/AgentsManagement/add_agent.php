...
$this->assign('title', SITE_TITLE.' :: Add Sub Admin');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Add Sub-Admin Details</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="first_name" name="first_name" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <span id="first_nameError" class="admin_login_error"></span>
                            </div>
                             <div class="form-group">
                                <label>Last Name:</label>
                                <input type="text" id="last_name" name="last_name" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
