...
$this->assign('title', SITE_TITLE.' :: Add State');
...
<div id="page-wrapper">
    <div class="row">
        <!-- page header -->
        <div class="col-lg-12">
            <h1 class="page-header">Add State Details</h1>
        </div>
        <!--end page header -->
    </div>
    <div class="row">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>State:</label>
                                <input type="text" id="state" name="state" onkeyup="checkError(this.id);" confirmation="false" class="form-control">
                                <span id="stateError" class="admin_login_error"></span>
                            </div>
                            <div class="form-group">
                                <label>Abbreviation</label>
                                <input type="text" name="abbreviation" id="abbreviation"  onkeyup="checkError(this.id);" class="form-control" /> 
